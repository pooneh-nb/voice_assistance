...
// NOTE: Added for the ProperData Alexa project network traffic logging.
static const std::string LOG_PATH("/home/pi/avs-network-traffic-log.csv");
static const std::string READ_FLAG("READ");
static const std::string WRITE_FLAG("WRITE");
...
private:
    ...
    // NOTE: Added for the ProperData Alexa project network traffic logging.
    static void logNetworkTrafficPayload(LibcurlHTTP2Request* stream, char* data, std::string rwFlag, bool verbose);
